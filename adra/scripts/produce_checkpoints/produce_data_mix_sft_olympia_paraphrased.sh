...
#     --contamination_dataset_name osieosie/olympiads-32-seed2-Paraphrased-Gemini-2.5-Flash-v3.0 \
#     --dataset_name mixed_olympiads_paraphrased_32_seed2_tulu3_sft_seed1_10.0pct \
...
dataset_mix_name="mixed_olympiads_paraphrased_32_seed2_tulu3_sft_seed1_10.0pct"

# Train model on mixed dataset
accelerate launch --config_file /gpfs/scrubbed/osey/Dataset_Distillation/ADRA/adra/scripts/produce_checkpoints/configs/accelerate_fsdp_tulu2-7b_h200_8.yaml 
