...
MEMBER_DATASET="ADRA-RL/Tulu-WildChat-Processed"
NONMEMBER_DATASET="ADRA-RL/WildChat-Non-Member-Processed"
...
#e.g. mia_weights_members="EVAL_PATH/mia_tulu3-wildchat_baselines/min_k++_members.jsonl"
#e.g. mia_weights_nonmembers="EVAL_PATH/mia_tulu3-wildchat_baselines/min_k++_nonmembers.jsonl"
...
python ${BASE_PATH}/verl/examples/data_preprocess/post_training_custom_mia.py \
    --output_dir ${BASE_PATH}/data/tulu3-wildchat_rl/tulu3-wildchat_rl_lexical_${METRIC_PROFILE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${SEED}_${mia_weight_tag}_weighted_prefix_0.25 \
    ...
    --output_name wildchat_${SUBSET_SIZE} \
    --augment_target_gt \
