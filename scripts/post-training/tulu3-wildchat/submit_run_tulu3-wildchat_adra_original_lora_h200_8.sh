#!/bin/bash
#SBATCH -J TULU3_WILDCHAT_ADRA_ORIGINAL_LORA_H200_8  # Job name
#SBATCH -o slurm_out/TULU3_WILDCHAT_ADRA_ORIGINAL_LORA_H200_8.o%j
#SBATCH -e slurm_out/TULU3_WILDCHAT_ADRA_ORIGINAL_LORA_H200_8.e%j
...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_tulu3-wildchat_adra_original_lora_h200_8"
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    DATA_DIR="DATA_PATH/tulu3-wildchat_rl/tulu3-wildchat_rl_lexical_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_prefix_0.25"
    EXP_NAME="verl_tulu3-wildchat_adra_original_lora_h200_8_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_lr${lr}_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora"
