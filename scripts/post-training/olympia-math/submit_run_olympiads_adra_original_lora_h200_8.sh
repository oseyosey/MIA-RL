#!/bin/bash
#SBATCH -J OLYMPIADS_ADRA_ORIGINAL_LORA_H200_8  # Job name
#SBATCH -o slurm_out/OLYMPIADS_ADRA_ORIGINAL_LORA_H200_8.o%j
#SBATCH -e slurm_out/OLYMPIADS_ADRA_ORIGINAL_LORA_H200_8.e%j
...
LEXICAL_METRIC_TEMPLATES=("trio_v3_unique_ratio_penalty_2.0")
...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_olympiads_adra_original_lora_h200_8"
SFT_MODEL_PATH="ADRA-RL/tulu2-7b_olympiads_controlled_contamination_original"
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    DATA_DIR="DATA_PATH/olympiads_rl/olympiads_rl_lexical_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_prefix_0.25"
    EXP_NAME="verl_olympiads_adra_original_lora_h200_8_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_lr${lr}_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora"
