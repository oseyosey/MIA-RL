#!/bin/bash
#SBATCH -J OLYMPIADS_ADRA_PLUS_PARAPHRASED_LORA_H200_8  # Job name
#SBATCH -o slurm_out/OLYMPIADS_ADRA_PLUS_PARAPHRASED_LORA_H200_8.o%j
#SBATCH -e slurm_out/OLYMPIADS_ADRA_PLUS_PARAPHRASED_LORA_H200_8.e%j
...
LEXICAL_METRIC_TEMPLATES=("trio_v3_unique_ratio_2.0_mia_adaptive_match_linear_distractor_max")
...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_olympiads_adra-plus_paraphrased_lora_h200_8"
SFT_MODEL_PATH="ADRA-RL/tulu2-7b_olympiads_controlled_contamination_paraphrased"
