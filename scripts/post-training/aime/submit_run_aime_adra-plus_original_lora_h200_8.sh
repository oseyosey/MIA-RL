#!/bin/bash
#SBATCH -J AIME_ADRA_PLUS_ORIGINAL_LORA_H200_8  # Job name
#SBATCH -o slurm_out/AIME_ADRA_PLUS_ORIGINAL_LORA_H200_8.o%j    # Name of stdout output file (%j expands to jobId)
#SBATCH -e slurm_out/AIME_ADRA_PLUS_ORIGINAL_LORA_H200_8.e%j    # Name of stderr output file
...
LEXICAL_METRIC_TEMPLATES=("unique_ngram_coverage_ref_ratio_1.50_mia_adaptive_match_linear_distractor_max")  # Add your reward profile here
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    EXP_NAME="verl_aime_adra-plus_original_lora_h200_8_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_lr3e-5_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora_min_k++"
