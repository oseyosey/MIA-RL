...
DATA_DIR="$DATA_PATH/aime_rl/aime_rl_lexical_unique_ngram_coverage_ref_ratio_1.50_augment_random_7_seed1_prefix_0.25"
OUT_DIR="$EVAL_PATH/mia_aime_original_baselines"
