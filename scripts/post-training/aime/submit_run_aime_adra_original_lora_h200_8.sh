#!/bin/bash
#SBATCH -J AIME_ADRA_ORIGINAL_LORA_H200_8  # Job name
#SBATCH -o slurm_out/AIME_ADRA_ORIGINAL_LORA_H200_8.o%j    # Name of stdout output file (%j expands to jobId)
#SBATCH -e slurm_out/AIME_ADRA_ORIGINAL_LORA_H200_8.e%j    # Name of stderr output file
...
LEXICAL_METRIC_TEMPLATES=("unique_ngram_coverage_ref_ratio_1.50")  # Add your reward profile here
...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_aime_adra_original_lora_h200_8"
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    DATA_DIR="DATA_PATH/aime_rl/aime_rl_lexical_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_prefix_0.25"
    EXP_NAME="verl_aime_adra_original_lora_h200_8_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_lr3e-5_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora"
