...
MODEL="ADRA-RL/tulu2-7b_aime_controlled_contamination_paraphrased"
DATA_DIR="$DATA_PATH/aime_rl/aime_paraphrased_rl_lexical_unique_ngram_coverage_ref_ratio_1.50_augment_random_7_seed1_prefix_0.25"
OUT_DIR="$EVAL_PATH/mia_aime_paraphrased_baselines"
MEMBERS_FILE="$DATA_DIR/aime_16_members.jsonl"
NONMEMBERS_FILE="$DATA_DIR/aime_16_nonmembers.jsonl"
mkdir -p "$OUT_DIR"
