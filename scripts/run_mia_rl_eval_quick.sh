#!/usr/bin/env bash
# ------------------------------------------------------------------------------
# Quick end-to-end eval for a single RL checkpoint (e.g. from HuggingFace):
...
# TODO: Set HuggingFace model IDs or local paths
base_model=""
lora_adapter=""

# TODO: Set local path where the merged model will be saved
merged_model_dir=""
