...
#   1. Generate n samples from a model using vLLM
#   2. Evaluate generated samples with lexical MIA metrics (match + full-suffix)
...
# TODO: Set path to the model to evaluate (HuggingFace ID or local path)
model_dir=""
