...
MODEL="ADRA-RL/qwen2.5-7b-instrct_s1_deepseek-r1_distillation_original"
DATA_DIR="$DATA_PATH/s1_rl/s1_deepseek_rl_lexical_trio_v3_unique_ratio_penalty_1.25"
OUT_DIR="$EVAL_PATH/mia_s1_deepseek-r1_baselines"
