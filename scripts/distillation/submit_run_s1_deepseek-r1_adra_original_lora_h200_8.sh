#!/bin/bash
#SBATCH -J S1_DEEPSEEK_R1_ADRA_ORIGINAL_LORA_H200_8  # Job name
#SBATCH -o slurm_out/S1_DEEPSEEK_R1_ADRA_ORIGINAL_LORA_H200_8.o%j
#SBATCH -e slurm_out/S1_DEEPSEEK_R1_ADRA_ORIGINAL_LORA_H200_8.e%j
...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_s1_deepseek-r1_adra_original_lora_h200_8"
SFT_MODEL_PATH="ADRA-RL/qwen2.5-7b-instrct_s1_deepseek-r1_distillation_original"
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    DATA_DIR="DATA_PATH/s1_rl/s1_deepseek_rl_lexical_${PROMPT_TEMPLATE}"
    EXP_NAME="verl_s1_deepseek-r1_adra_original_lora_h200_8_${PROMPT_TEMPLATE}_lr${lr}_temp${temperature}_topp${top_p}_topk${top_k}_128_lora"
