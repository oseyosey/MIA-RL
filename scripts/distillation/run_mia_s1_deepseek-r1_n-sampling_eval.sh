...
# e.g. data_path="${BASE_PATH}/data/s1_rl/s1_deepseek_rl_lexical_trio_v3_unique_ratio_penalty_1.25/train.parquet"
data_path=""

# TODO: Set path to the model to evaluate (SFT or RL checkpoint)
model_dir="ADRA-RL/qwen2.5-7b-instrct_s1_deepseek-r1_distillation_original"

# TODO: Set the output directory name for evaluation artifacts
eval_model_dir="mia_s1_deepseek-r1_n-sampling"
