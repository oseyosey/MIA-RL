...
# Configuration
DATASET_PATH="osieosie/dolma3-arxiv_64_seed2-Paraphrased-Gemini-2.5-Flash-v3.0"
INPUT_FIELD="text"
...
# mia_weights_members="${BASE_PATH}/Dataset_Distillation/eval/M9.1_baselines/mia_bookmia_m9.1_seed${SUBSET_SEED}/min_k++_members.jsonl"
# mia_weights_nonmembers="${BASE_PATH}/Dataset_Distillation/eval/M9.1_baselines/mia_bookmia_m9.1_seed${SUBSET_SEED}/min_k++_nonmembers.jsonl"
...
# Uncomment the following lines if using MIA weights:
