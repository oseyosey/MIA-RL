...
# Configuration
DATASET_PATH="osieosie/dolma3-arxiv-1024_64_seed2-Paraphrased-Gemini-2.5-Flash-v3.0"
INPUT_FIELD="text"
...
OUTPUT_DIR="${BASE_PATH}/Dataset_Distillation/data/dolma3-arxiv_rl/dolma3-arxiv-mia-1k-1024_paraphrased_${SUBSET_SIZE}_rl_lexical_${METRIC_PROFILE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${SUBSET_SEED}_prefix_${PREFIX_RATIO}_assist_${ASSISTANT_PREFIX_RATIO}"
OUTPUT_NAME="dolma3-arxiv_${SUBSET_SIZE}"

# Optional: MIA weights files (comment out if not available)
mia_weights_members="${BASE_PATH}/Dataset_Distillation/eval/M9.4_paraphrased_baselines/mia_dolma3-arxiv-1024_m9.4_paraphrased_olmo3-7b-instruct_seed${SUBSET_SEED}/loss_members.jsonl"
mia_weights_nonmembers="${BASE_PATH}/Dataset_Distillation/eval/M9.4_paraphrased_baselines/mia_dolma3-arxiv-1024_m9.4_paraphrased_olmo3-7b-instruct_seed${SUBSET_SEED}/loss_nonmembers.jsonl"
mia_weight_tag="loss"
