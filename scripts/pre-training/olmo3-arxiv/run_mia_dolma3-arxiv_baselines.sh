...
DATA_DIR="/gpfs/scrubbed/osey/Dataset_Distillation/data/dolma3-arxiv_rl/dolma3-arxiv-mia-1k-1024_64_rl_lexical_trio_v3_unique_ratio_penalty_1.50_augment_random_7_seed${SEED}_prefix_0.25_assist_0.25"
OUT_DIR="/gpfs/scrubbed/osey/Dataset_Distillation/eval/M9.4_baselines_seed${SEED}/mia_dolma3-arxiv-1024_m9.4_olmo3-7b-instruct_seed${SEED}"
