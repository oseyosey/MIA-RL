...
DATA_DIR="$DATA_PATH/dolma3-arxiv_rl/dolma3-arxiv-mia-1k_64_rl_lexical_trio_v3_unique_ratio_penalty_1.50_augment_random_7_seed${SEED}_prefix_0.25_assist_0.25"
OUT_DIR="$EVAL_PATH/mia_dolma3-arxiv_baselines"
