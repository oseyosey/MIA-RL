#!/bin/bash
#SBATCH -J DOLMA3_ARXIV_PARAPHRASED_ADRA_PLUS_LORA_H200_8  # Job name
#SBATCH -o slurm_out/DOLMA3_ARXIV_PARAPHRASED_ADRA_PLUS_LORA_H200_8.o%j    # Name of stdout output file (%j expands to jobId)
#SBATCH -e slurm_out/DOLMA3_ARXIV_PARAPHRASED_ADRA_PLUS_LORA_H200_8.e%j    # Name of stderr output file
