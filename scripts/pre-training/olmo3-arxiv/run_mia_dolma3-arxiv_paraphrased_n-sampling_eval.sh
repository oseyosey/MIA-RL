...
for temperature in "${temperatures[@]}"; do
  for top_p in "${top_ps[@]}"; do
    ...
    eval_model_dir="M9.4_paraphrased_baselines_seed${seed}/mia_dolma3-arxiv-1024_m9.4_paraphrased_olmo3-7b-instruct_seed${seed}_budget${n_samples}_temp${temperature}_topp${top_p}_topk${top_k}_prefix_0.25_match_maxtok1024"

    # Output artifacts
    save_path="${BASE_PATH}/Dataset_Distillation/eval/${eval_model_dir}/mia_dolma3-arxiv-1024_m9.4_paraphrased_olmo3-7b-instruct_seed${seed}_budget${n_samples}_temp${temperature}_topp${top_p}_topk${top_k}_prefix_0.25_maxtok1024.parquet"
    eval_match_json="${BASE_PATH}/Dataset_Distillation/eval/${eval_model_dir}/mia_dolma3-arxiv-1024_m9.4_paraphrased_olmo3-7b-instruct_seed${seed}_budget${n_samples}_temp${temperature}_topp${top_p}_topk${top_k}_prefix_0.25_match_maxtok1024.json"
    eval_json="${BASE_PATH}/Dataset_Distillation/eval/${eval_model_dir}/mia_dolma3-arxiv-1024_m9.4_paraphrased_olmo3-7b-instruct_seed${seed}_budget${n_samples}_temp${temperature}_topp${top_p}_topk${top_k}_prefix_0.25_maxtok1024.json"
