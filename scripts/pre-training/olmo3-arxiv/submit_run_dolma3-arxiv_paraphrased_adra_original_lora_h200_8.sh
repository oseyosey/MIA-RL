#!/bin/bash
#SBATCH -J DOLMA3_ARXIV_PARAPHRASED_ADRA_ORIGINAL_LORA_H200_8  # Job name
#SBATCH -o slurm_out/DOLMA3_ARXIV_PARAPHRASED_ADRA_ORIGINAL_LORA_H200_8.o%j    # Name of stdout output file (%j expands to jobId)
#SBATCH -e slurm_out/DOLMA3_ARXIV_PARAPHRASED_ADRA_ORIGINAL_LORA_H200_8.e%j    # Name of stderr output file
...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_olmo3-7b-instruct_paraphrased_lexical_seed${seed}"
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    DATA_DIR="DATA_PATH/dolma3-arxiv_rl/dolma3-arxiv-mia-1k_paraphrased_64_rl_lexical_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_prefix_0.25_assist_0.25"
    EXP_NAME="verl_olmo3-7b-instruct_dolma3-arxiv_seed${seed}_paraphrased_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora_prefix_0.25_assist_0.25"
