...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_m9.4_olmo3-7b-instruct_paraphrased_lexical_seed${seed}"
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    DATA_DIR="/gpfs/scrubbed/osey/Dataset_Distillation/data/dolma3-arxiv_rl/dolma3-arxiv-mia-1k-1024_paraphrased_64_rl_lexical_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_prefix_0.25_assist_0.25" # DATA up sampled to 128 samples (must be integer multiple of # of GPUs)
    EXP_NAME="verl_olmo3-7b-instruct_dolma3-arxiv-1024_seed${seed}_m9.4_paraphrased_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora_prefix_0.25_assist_0.25_match_maxtok1024"
