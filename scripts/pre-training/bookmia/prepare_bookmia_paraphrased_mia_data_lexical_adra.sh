...
python ${BASE_PATH}/verl/examples/data_preprocess/pre_training_custom_mia.py \
    --output_dir ${BASE_PATH}/data/bookmia_rl/bookmia_paraphrased_${SUBSET_SIZE}_rl_lexical_${METRIC_PROFILE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${SEED}_prefix_${PREFIX_RATIO}_assist_${PREFIX_RATIO} \
