...
# e.g. data_path="${BASE_PATH}/data/bookmia_rl/bookmia_paraphrased_64_rl_lexical_trio_v3_unique_ratio_penalty_1.50_augment_random_7_seed1_prefix_0.25_assist_0.25/train.parquet"
data_path=""
...
PROMPT_TEMPLATE="trio_v3_unique_ratio_penalty_1.50"
...
# ------------------------------------------------------------------------------
for global_step in 5 10 15 20 25 30; do
  echo "=============================================================================="
  ...
  merged_model_dir="${BASE_PATH}/Dataset_Distillation/DDRL/verl_checkpoints/Experiment_M9.2_llama2-7b_paraphrased_seed${seed}/merged_models/${merged_base_name}_step_${global_step}"
  eval_model_dir="M9.2_rl_llama2-7b_paraphrased_seed${seed}/${eval_base_name}_step_${global_step}_match"
