#!/bin/bash
#SBATCH -J BOOKMIA_ADRA_ORIGINAL_LORA_H200_8
#SBATCH -o slurm_out/BOOKMIA_ADRA_ORIGINAL_LORA_H200_8.o%j
#SBATCH -e slurm_out/BOOKMIA_ADRA_ORIGINAL_LORA_H200_8.e%j
#SBATCH -N 1
#SBATCH -n 8
#SBATCH --mem=1200gb
#SBATCH -t 24:00:00
...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_bookmia_adra_original_lora_h200_8"
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    DATA_DIR="DATA_PATH/bookmia_rl/bookmia_64_rl_lexical_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_prefix_0.25_assist_0.25"
    EXP_NAME="verl_bookmia_adra_original_lora_h200_8_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_lr${lr}_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora"
