...
DATA_DIR="$DATA_PATH/bookmia_rl/bookmia_64_rl_lexical_unique_ngram_coverage_ref_ratio_1.50_augment_random_3_seed1_prefix_0.25_assist_0.25"
OUT_DIR="$EVAL_PATH/mia_bookmia_baselines"
