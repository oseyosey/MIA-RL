#!/bin/bash
#SBATCH -J WIKIMIA24_HARD_ADRA_PLUS_ORIGINAL_LORA_H200_8  # Job name
#SBATCH -o slurm_out/WIKIMIA24_HARD_ADRA_PLUS_ORIGINAL_LORA_H200_8.o%j    # Name of stdout output file (%j expands to jobId)
#SBATCH -e slurm_out/WIKIMIA24_HARD_ADRA_PLUS_ORIGINAL_LORA_H200_8.e%j    # Name of stderr output file
...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_wikimia24-hard_adra-plus_original_lora_h200_8"
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    DATA_DIR="DATA_PATH/wikimia24_hard_rl/wikimia24_hard_64_rl_lexical_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_prefix_0.25_assist_0.25" # TODO: set DATA_PATH
    EXP_NAME="verl_wikimia24-hard_original_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_lr${lr}_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora"
