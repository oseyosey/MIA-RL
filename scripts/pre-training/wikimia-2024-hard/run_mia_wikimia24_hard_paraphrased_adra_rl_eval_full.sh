...
# TODO: Set data_path
# e.g. data_path="${BASE_PATH}/data/wikimia24_hard_rl/wikimia24_hard_paraphrased_64_rl_lexical_trio_v3_unique_ratio_penalty_1.50_augment_perturbed_3_seed1_prefix_0.25_assist_0.25/train.parquet"
data_path=""
...
# TODO: Set exp_name to the name of the RL experiment you ran
exp_name="verl_wikimia24-hard_paraphrased_adra-plus_lora_h200_8_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_lr${lr}_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora"
...
for global_step in 5 10 15 20; do
  echo "=============================================================================="
