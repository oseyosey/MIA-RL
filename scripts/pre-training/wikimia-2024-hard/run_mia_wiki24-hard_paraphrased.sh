...
MODEL="Qwen/Qwen2-7B"
DATA_DIR="$DATA_PATH/wikimia24_hard_rl/wikimia24_hard_paraphrased_64_rl_lexical_trio_v3_unique_ratio_penalty_1.50_augment_perturbed_3_seed1_prefix_0.25_assist_0.25"
OUT_DIR="$EVAL_PATH/mia_wikimia24-hard_paraphrased_baselines"
