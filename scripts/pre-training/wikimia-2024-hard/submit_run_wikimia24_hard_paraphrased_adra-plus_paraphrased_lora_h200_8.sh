#!/bin/bash
#SBATCH -J WIKIMIA24_HARD_PARAPHRASED_ADRA_PLUS_LORA_H200_8  # Job name
#SBATCH -o slurm_out/WIKIMIA24_HARD_PARAPHRASED_ADRA_PLUS_LORA_H200_8.o%j    # Name of stdout output file (%j expands to jobId)
#SBATCH -e slurm_out/WIKIMIA24_HARD_PARAPHRASED_ADRA_PLUS_LORA_H200_8.e%j    # Name of stderr output file
...
LEXICAL_METRIC_TEMPLATES=("trio_v3_unique_ratio_1.50_mia_adaptive_match_linear_distractor_max")
...
OUTPUT_PATH="./outputs"
PROJECT_NAME="verl_wikimia24-hard_paraphrased_adra-plus_lora_h200_8"
SFT_MODEL_PATH="Qwen/Qwen2-7B"
...
for PROMPT_TEMPLATE in "${LEXICAL_METRIC_TEMPLATES[@]}"; do
    ...
    DATA_DIR="DATA_PATH/wikimia24_hard_rl/wikimia24_hard_paraphrased_64_rl_lexical_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_prefix_0.25_assist_0.25" # TODO: set DATA_PATH
    EXP_NAME="verl_wikimia24-hard_paraphrased_${PROMPT_TEMPLATE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${seed}_lr${lr}_temp${temperature}_topp${top_p}_topk${top_k}_rollout${rollout_n}_lora"
