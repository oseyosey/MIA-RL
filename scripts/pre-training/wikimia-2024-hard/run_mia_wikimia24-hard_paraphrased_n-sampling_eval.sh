...
# e.g. data_path="${BASE_PATH}/data/wikimia24_hard_rl/wikimia24_hard_paraphrased_64_rl_lexical_trio_v3_unique_ratio_penalty_1.50_augment_perturbed_3_seed1_prefix_0.25_assist_0.25_diff400_tokens256-1024/train.parquet"
data_path=""
...
eval_model_dir="mia_wikimia24-hard_paraphrased_n-sampling"
