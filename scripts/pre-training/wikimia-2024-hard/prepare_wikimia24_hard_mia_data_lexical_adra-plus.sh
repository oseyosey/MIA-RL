...
# e.g. mia_weights_members="EVAL_PATH/mia_wikimia24-hard_baselines/min_k++_members.jsonl"
# e.g. mia_weights_nonmembers="EVAL_PATH/mia_wikimia24-hard_baselines/min_k++_nonmembers.jsonl"
mia_weights_members=""
mia_weights_nonmembers=""
mia_weight_tag="min_k++"

python ${BASE_PATH}/verl/examples/data_preprocess/pre_training_custom_mia.py \
    --output_dir ${BASE_PATH}/data/wikimia24_hard_rl/wikimia24_hard_${SUBSET_SIZE}_rl_lexical_${METRIC_PROFILE}_augment_${AUGMENT_SAMPLING_METHOD}_${AUGMENT_NUM_SAMPLES}_seed${SEED}_prefix_${PREFIX_RATIO}_assist_${PREFIX_RATIO} \
